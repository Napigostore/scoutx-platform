...
const tokenVerifier = new SimpleTokenVerifier(
...
`;
fs.writeFileSync("apps/web/src/app/api/auth/sign-in/route.ts", content, "utf8");
console.log("Successfully wrote apps/web/src/app/api/auth/sign-in/route.ts");
