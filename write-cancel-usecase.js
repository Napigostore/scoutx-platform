...
`;
fs.writeFileSync("packages/application/src/use-cases/CancelMissionUseCase.ts", content, "utf8");
console.log("Successfully wrote CancelMissionUseCase.ts");
