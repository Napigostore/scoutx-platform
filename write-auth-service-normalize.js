const fs = require("fs");
const content = `import type { AuthenticatedPrincipal, Permission } from "../contracts/index";
...
`;
fs.writeFileSync("packages/auth/src/authorization/AuthorizationService.ts", content, "utf8");
console.log("Successfully wrote packages/auth/src/authorization/AuthorizationService.ts");
