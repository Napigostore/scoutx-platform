...
`;
fs.writeFileSync("apps/web/src/app/api/missions/[missionId]/cancel/route.ts", content, "utf8");
console.log("Successfully wrote apps/web/src/app/api/missions/[missionId]/cancel/route.ts");
