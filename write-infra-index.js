const fs = require("fs");
const content = `export * from "./repositories/DiscoveryRepository";
...
`;
fs.writeFileSync("packages/infrastructure/src/index.ts", content, "utf8");
console.log("Successfully wrote packages/infrastructure/src/index.ts");
