...
export class PrismaMissionRepository implements MissionRepository {
  async create(mission: Mission): Promise<void> {
    ...
    await prisma.mission.create({
      data: {
        ...
        minimumTrustScore: mission.minimumTrustScore,
        minimumQualityScore: mission.minimumQualityScore,
        minimumCompletedMissions: mission.minimumCompletedMissions,
        verifiedOnly: mission.verifiedOnly || false,
  ...
  async findById(id: string): Promise<Mission | null> {
    ...
    return {
      ...
      quotas: row.quotas,
      minimumTrustScore: row.minimumTrustScore ?? undefined,
      minimumQualityScore: row.minimumQualityScore ?? undefined,
      minimumCompletedMissions: row.minimumCompletedMissions ?? undefined,
